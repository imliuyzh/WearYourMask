/**
 * The model and all the code in detection.js are from:
 * https://github.com/AIZOOTech/mask-detection-web-demo
 * 
 * Without AIZOOTech's work, I cannot finish this project. Thanks!
 */
...
let featureMapSizes = [[33, 33], [17, 17], [9, 9], [5, 5], [3,3]],
    ...
    anchors = anchorGenerator(featureMapSizes, anchorSizes, anchorRatios);
...
export async function detect(imgToPredict) {
...
export async function loadModel() {
  model = await tf.loadLayersModel('scripts/model/model.json');
}